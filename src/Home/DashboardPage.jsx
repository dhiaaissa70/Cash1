...
const menuItems = [
  ...
  { label: 'Totaux des Transactions', icon: <FaSyncAlt size={24} />, route: '/transaction-totals', hasArrow: false },
  { label: 'Historique des Transactions', icon: <FaHistory size={24} />, route: '/transaction-history', hasArrow: false },
  { label: 'Arbre des Utilisateurs', icon: <FaSitemap size={24} />, route: '/user-tree', hasArrow: false },
  { label: 'Coupons', icon: <FaTicketAlt size={24} />, route: '/coupons', hasArrow: false },
  { label: 'Retrait', icon: <FaMoneyBill size={24} />, route: '/withdraw', hasArrow: false },
  { label: 'Affiliés', icon: <FaHandshake size={24} />, route: '/affiliates', hasArrow: false },
];
